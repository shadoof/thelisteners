...
public class Fragments extends ListResourceBundle {
	...
	public Object[][] contents = { { "fragment0", buildFragment(0) },
			...
			{ "fragment3", buildFragment(3) },
			{ "fragment4", buildFragment(4) },
			{ "fragment5", buildFragment(5) },
			{ "fragment6", buildFragment(6) },
			{ "fragment7", buildFragment(7) },
			{ "fragment8", buildFragment(8) },
			{ "fragment9", buildFragment(9) } };
