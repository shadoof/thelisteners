...
public class LangConstantsBundle_es_MX extends LangConstantsBundle {
	...
	protected HashMap getSpecialAffectsMap() {
		...
		specialAffectsMap.put("hambre", NEGATIVE);
	...
	protected HashMap getAffectivejj2nnMap() {
		...
		affectivejj2nnMap.put("excelente", "chido");
		...
		affectivejj2nnMap.put("chido", "apatía");
		...
		affectivejj2nnMap.put("perturbado", "incomodidad");
		...
		affectivejj2nnMap.put("súper bien", "felicidad");
		affectivejj2nnMap.put("rela", "buena onda");
		...
		affectivejj2nnMap.put("normal", "apatía");
		...
		affectivejj2nnMap.put("asustado", "miedo");
		affectivejj2nnMap.put("a salvo", "seguridad");
		...
		affectivejj2nnMap.put("extraño", "extrañeza");
		...
		affectivejj2nnMap.put("inquietado", "lo inquietante");
		...
		affectivejj2nnMap.put("raro", S("extrañeza", "rareza"));
	...
	protected HashSet getPictureWords() {
		...
		pictureWords.add("cortada de papel");
