...
public class SecureIntent_fr_FR extends SecureIntent {
	...
	public String buildCardTitle() {
		...
		return r("Votre `Notre `La ") + "sécurité est importante " + s(S("pour vous", "pour nous"));
	}
	...
	public String buildSpeech() {
		...
		speech += "Et que " + s("vous, aussi,", "vous") + s("serez ", "vous sentirez")
				+ r("en sécurité, `à l'abri, `hors de portée, ")
				+ s("à mesure que vous vous confierez à nous,");
		speech += "nous " + s("permettant d'aller,", "donnant accès, toujours") + "au sein de ces "
				+ s("espaces", "espaces intérieurs") + "depuis lesquels vous vous exprimez " + s("à nous,");
