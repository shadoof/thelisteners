...
public class LangConstants {
	...
	private static String sessionLangTag;
	...
	public static void setLangConstants(String langTag) {

		sessionLangTag = langTag;
	...
	public static String getSessionLangTag() {
		
		return sessionLangTag;
	}

	
	public static void setSessionLangTag(String sessionLangTag) {
	
		LangConstants.sessionLangTag = sessionLangTag;
	}
