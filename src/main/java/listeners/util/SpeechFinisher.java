...
public class SpeechFinisher {
	...
	public SpeechFinisher(String langTag, String speech, String reprompt, String postSpeechPrompt) {
		

			// TODO if (speech == null || reprompt == null) throw new SpeechletException("Nothing to say ... for Fragment: " + fragmentIndex);

			// Create the Simple card content.
		// TODO
//			SimpleCard card = new SimpleCard();
//			if (DEV && !intentName.isEmpty())
//				card.setTitle(intentName);
//			else
//				card.setTitle(cardTitle);
//			switch (langTag) {
//				case "de-DE":
//					cardTitle = S("Hören", "Höre immer noch zu"); // just making sure to
//																												// reset the default
//					break;
//				case "ja-JP":
//					// break;
...
//				case "en-GB":
//				default: // "en-US" etc.
//					cardTitle = S("Still, l", "L") + "istening"; // just making sure to
//																												// reset the default
//			}
			date = new Date();
			...
			info("@SpeechFinisher: " + dateString + ". Reprompt was: " + stripSsmlTags(reprompt));
...
//						switch (langTag) {
//							case "de-DE":
//								speech += breathLong() + s(s("Entschuldigen uns.", "Entschuldigen Sie uns!") + "Wir sind nicht sicher, warum wir das gesagt haben. " + breathLong(), s("Bitte entschuldigen Sie uns.", "") + "Ähm.");
//								break;
//							case "ja-JP":
//								// break;
//							case "en-CA":
...
//							case "en-GB":
//							default: // "en-US" etc.
//								speech += breathLong() + s(s("Sorry.", "Excuse us!") + "We're not sure what came over us. " + breathLong(), s("Excuse us.", "") + "Ahem.");
//						}
//					}
...
//			}
//
//			speech = insertPauseTags((isAskResponse ? preSpeech : "") + speech + (isAskResponse ? postSpeechPrompt : ""));
//
//			String guyzIrq = "";
//			switch (langTag) {
//				case "de-DE":
...
//				case "en-GB":
//				default: // "en-US" etc.
//					guyzIrq = s(s("[the 'guyz'", "[other voices"), s("[another voice", "[the other voice" + s("s", "") + SPC)) + "interrupted here ...] ";
//			}
//			String cardSpeech = speech.replaceAll("<guyz> ", guyzIrq);
//			card.setContent(stripSsmlTags(cardSpeech) + ((DEV || PERF) ? " - " + dateString : ""));
...
// *** TO HERE ***
			...
			// TODO:
//			if (isAskResponse) {
//				return SpeechletResponse.newAskResponse(ssmlSpeech, repromptObject, card);
//
//			}
